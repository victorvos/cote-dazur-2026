# Checklist — wat moet er nog gebeuren

Zo veel mogelijk vóór vertrek regelen; de rest lekker met de dag.
...
- [ ] SNCF Connect app installeren (treinkaartjes als QR).
- [ ] Cash/kaart voor Monaco & terrassen.
...
- [x] Ferry Nice → Monaco: **7 plekken gereserveerd** (za 25 jul) — betalen pas 45 min
  vóór vertrek; beslissing vrijdag.
